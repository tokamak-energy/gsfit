...
///
/// # Arguments
/// * `r` - R coordinate of the point, shape = [n_filaments], [metre]
/// * `z` - Z coordinate of the point, shape = [n_filaments], [metre]
/// * `r_prime` - R coordinate of the conductor filaments, shape = [n_filaments_prime], [metre]
/// * `z_prime` - Z coordinate of the conductor filaments, shape = [n_filaments_prime], [metre]
/// * `d_r_prime` - Radial width of the conductor filaments (note, area = d_r_prime * d_z_prime), shape = [n_filaments_prime], [metre]
/// * `d_z_prime` - Vertical height of the conductor filaments, shape = [n_filaments_prime], [metre]
/// * `angle_1_prime` - Angle of the first side of the conductor filaments, shape = [n_filaments_prime], [radian]
/// * `angle_2_prime` - Angle of the second side of the conductor filaments, shape = [n_filaments_prime], [radian]
///
/// # Returns
/// * `g_psi` - Mutual inductance between the two sets of filaments, shape = [n_filaments, n_filaments_prime], [henry]
pub fn mutual_inductance_finite_size_to_point_source(
    r: &Array1<f64>,
    z: &Array1<f64>,
    r_prime: &Array1<f64>,
    z_prime: &Array1<f64>,
    ...
    unimplemented!("TODO: implement mutual_inductance_finite_size_to_point_source");
