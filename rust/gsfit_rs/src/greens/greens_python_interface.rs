...
pub fn greens_d3_psi_d_z3(
    ...
    greens_table.d3_psi_d_z3().into_pyarray(py).into()
}

#[pyfunction]
#[pyo3(signature = (r, z, r_prime, z_prime, d_r=None, d_z=None))]
pub fn greens_d3_psi_d_r2_d_z(
    py: Python,
    r: PyReadonlyArray1<f64>,
    z: PyReadonlyArray1<f64>,
    r_prime: PyReadonlyArray1<f64>,
    ...
    greens_table.d3_psi_d_r2_d_z().into_pyarray(py).into()
}

#[pyfunction]
#[pyo3(signature = (r, z, r_prime, z_prime, d_r=None, d_z=None))]
pub fn greens_d3_psi_d_r_d_z2(
    py: Python,
    r: PyReadonlyArray1<f64>,
    z: PyReadonlyArray1<f64>,
    r_prime: PyReadonlyArray1<f64>,
