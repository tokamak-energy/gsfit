...
use super::profiles_1d_r_midplane_h;
...
pub fn equilibrium_post_processor(
    ...
    let calculators_unsorted: Vec<CalculatorEntry> = vec![
        ...
        entry(CI::boundary__gap__value,                                                        boundary::gap__value::calculate,                                                        &[CI::boundary__outline__r__z]                                                                                                                      ),
        ...
        entry(CI::profiles_1d__r_inboard__r_outboard,                                          profiles_1d::r_inboard__r_outboard::calculate,                                          &[]                                                                                                                                                 ),
        entry(CI::profiles_1d__r_inboard_z_0__r_outboard_z_0,                                  profiles_1d::r_inboard_z_0__r_outboard_z_0::calculate,                                  &[]                                                                                                                                                 ),
        ...
        entry(CI::profiles_1d_r_midplane_h__r__psi__psi_norm,                                  profiles_1d_r_midplane_h::r__psi__psi_norm::calculate,                                  &[]                                                                                                                                                 ),
